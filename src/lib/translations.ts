export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ca: {
    ...
    // Dashboard
    active_objective: 'TEMÀTICA ACTUAL',
    my_photo: 'LA MEVA FOTO',
    upload_photo_label: 'Puja la teva foto per participar',
    photo_pending: 'Foto pujada (pendent) ⏳',
    photo_published: 'Foto publicada ✅',
    voting_progress: 'PROGRÉS DE VOTACIONS',
    members_voted: 'imatges votades',
    close_voting_btn: 'Tancar Votacions i Revelar Noms',
    // Photos
    manage_photos: 'GESTIÓ DE FOTOS',
    photos_subtitle: 'Fotos rebudes dels participants',
    publish_btn: 'Publicar Fotos',
    delete_selected: 'Eliminar Seleccionades',
    no_photos: "No s'han rebut fotos encara.",
    // Voting
    voting_title: 'VOTACIÓ',
    save_votes_btn: 'Enviar Vots',
    your_photo: '⭐ La teva foto',
    ...
    // Ranking
    current_ranking: 'Temàtica Actual',
    general_ranking: 'Ranking General',
    ranking_title: 'RANKING GENERAL',
    participations: 'participació(ns)',
    // Objectives
    objectives_title: 'GESTIÓ DE TEMÀTIQUES',
    new_objective_btn: 'Nova Temàtica',
    obj_title_label: 'Títol',
    obj_desc_label: 'Descripció',
    finalize_btn: 'Finalitzar',
    edit_btn: 'Editar',
    delete_btn: 'Eliminar',
    active_badge: 'Actiu',
    finished_badge: 'Finalitzat',
    inactive_badge: 'Inactiu',
    save_btn: 'Guardar',
    ...
    // Members
    members_title: 'GESTIÓ DE SOCIS',
    new_member_btn: 'Nou Soci',
    member_name: 'Nom',
    member_email: 'Email / Usuari',
    member_role: 'Rol',
    member_photo: 'Foto',
    member_voted: 'Votat',
    member_actions: 'Contrasenya',
    member_uploaded: 'Foto pujada',
    member_voted_h: 'Ha Votat',
    member_reset_pwd: 'Reset',
    member_reset_confirm_title: 'Resetejar contrasenya',
    ...
    // Settings
    uploads_toggle: 'Pujada de fotos',
    voting_toggle: 'Votacions obertes',
    ...
    resetting_ranking: 'Reiniciant Ranking...',
    deleting_objective: 'Eliminant temàtica...',
    ...
    objective_deleted: 'Temàtica eliminada i dades netes ✅',
    ranking_reset: 'Ranking General reiniciado ✅',
    ...
    confirm_delete_objective: "Eliminar '{name}'? S\'eliminaran totes les fotos, vots i puntuacions del Rànquing General. Aquesta acció no es pot desfer.",
    ...
    photo_of: 'de',
    // -- NEW Zampa keys --
    zampa_preparations: 'Preparant l\'exposició Zampa d\'aquest any. Properament.',
    zampa_title: 'Premis Zampa',
    zampa_vote_banner: 'Fase de votació de l\'exposició activa. Selecciona la posició de cada projecte.',
    zampa_closed_banner: 'S\'ha tancat la votació de socis. En breu es publicaran els resultats.',
    zampa_send_rating: 'Enviar Valoració Zampa',
    ...
    zampa_admin_projects: 'Projectes d\'autors d\'aquest any',
    ...
    zampa_pujada_conclosa: 'Càrrega de projectes tancada',
    zampa_pujar_foto: 'Pujar foto al mosaic',
    zampa_finalitzar_pujada: 'Finalitzar Edició Autor',
    zampa_next_photo: 'Pujar Següent Foto',
    zampa_real_results: 'Resultats Reals de la Jornada',
    zampa_jurat_winner: 'Guanyador del Jurat Oficial',
    zampa_popular_rankings: 'Resultat del Vot Popular (Sala)',
    zampa_finished_info: 'Cens consolidat i tancat. Resultats històrics i comparatives habilitades.',
    zampa_diana_adult: 'La Diana de Zampa',
    zampa_proximitat_jurat: 'Proximitat a la decisió dels jutges',
    zampa_soci_rank_for_winner: 'Posició atorgada al projecte campió',
    zampa_afinitat_popular: 'Afinitat Popular (Desviació Manhattan)',
    zampa_afinitat_info: 'Els socis es classifiquen segons la menor desviació global amb el vot popular de la sala.',
    zampa_soci_distance: 'Dissens Global (Desviació)',
  },
  es: {
    // Nav
    ...
    // Dashboard
    active_objective: 'TEMÁTICA ACTUAL',
    my_photo: 'MI FOTO',
    upload_photo_label: 'Sube tu foto para participar',
    photo_pending: 'Foto subida (pendiente) ⏳',
    photo_published: 'Foto publicada ✅',
    voting_progress: 'PROGRESO DE VOTACIONES',
    members_voted: 'imágenes votadas',
    close_voting_btn: 'Cerrar Votaciones y Revelar Nombres',
    // Photos
    manage_photos: 'GESTIÓN DE FOTOS',
    photos_subtitle: 'Fotos recibidas de los participantes',
    publish_btn: 'Publicar Fotos',
    delete_selected: 'Eliminar Seleccionadas',
    no_photos: 'No se han recibido fotos todavía.',
    // Voting
    voting_title: 'VOTACIÓN',
    save_votes_btn: 'Enviar Votos',
    your_photo: '⭐ Tu foto',
    ...
    // Ranking
    current_ranking: 'Temática Actual',
    general_ranking: 'Ranking General',
    ranking_title: 'RANKING GENERAL',
    participations: 'participación(es)',
    // Objectives
    objectives_title: 'GESTIÓN DE TEMÁTICAS',
    new_objective_btn: 'Nueva Temática',
    obj_title_label: 'Título',
    obj_desc_label: 'Descripción',
    finalize_btn: 'Finalizar',
    edit_btn: 'Editar',
    delete_btn: 'Eliminar',
    active_badge: 'Activa',
    finished_badge: 'Finalizada',
    inactive_badge: 'Inactiva',
    save_btn: 'Guardar',
    cancel_btn: 'Cancelar',
    no_objectives: 'No hay temáticas. Crea una para empezar.',
    confirm_upload_btn: 'Confirmar Subida',
    no_active_objective: 'No hay temática activa. Crea una en la pestaña Temáticas.',
    members_total: 'Total Socios',
    ...
    new_member_btn: 'Nuevo Socio',
    member_name: 'Nombre',
    member_email: 'Email / Usuario',
    member_role: 'Rol',
    member_photo: 'Foto',
    member_voted: 'Votado',
    member_actions: 'Contraseña',
    member_uploaded: 'Foto subida',
    member_voted_h: 'Ha Votado',
    member_reset_pwd: 'Reset',
    member_reset_confirm_title: 'Resetear contraseña',
    ...
    new_pwd_modal_title: 'CREA UNA NUEVA CONTRASEÑA2',
    ...
    yes_btn: 'Sí, resetear',
    // Settings
    uploads_toggle: 'Subida de fotos',
    voting_toggle: 'Votaciones abiertas',
    reveal_toggle: 'Revelar Nombres',
    reveal_hint: '🔒 Cierra las votaciones primero',
    hide_ranking_toggle: 'Ocultar Ranking General',
    // Upload
    upload_zone_title: 'Selecciona o arrastra tu foto',
    upload_zone_subtitle: 'JPG, PNG, WEBP · Se comprimirá automáticamente',
    ...
    nav_resultats_sub: 'Resultados del reto actual',
    ...
    resetting_ranking: 'Reiniciando Ranking...',
    deleting_objective: 'Eliminando temática...',
    // Extra toast messages
    ...
    objective_deleted: 'Temática eliminada y datos limpios ✅',
    ranking_reset: 'Ranking General reiniciado ✅',
    ...
    confirm_delete_objective: '¿Eliminar "{name}"? Se eliminarán todas las fotos, votos y puntuaciones del Ranking General. Esta acción no se puede deshacer.',
    ...
    photo_of: 'de',
    // -- NEW Zampa keys --
    zampa_preparations: 'Preparando la exposición Zampa de este año. Próximamente.',
    ...
    zampa_closed_banner: 'Se ha cerrado la votación de socios. En breve se publicarán los resultados.',
    zampa_send_rating: 'Enviar Valoración Zampa',
    ...
    zampa_admin_projects: 'Proyectos de autores de este año',
    ...
    zampa_pujada_conclosa: 'Carga de proyectos cerrada',
    zampa_pujar_foto: 'Subir foto a mosaico',
    zampa_finalitzar_pujada: 'Finalizar Edición Autor',
    zampa_next_photo: 'Subir Siguiente Foto',
    zampa_real_results: 'Resultados Reales de la Jornada',
    zampa_jurat_winner: 'Ganador del Jurado Oficial',
    zampa_popular_rankings: 'Resultado del Voto Popular (Sala)',
    zampa_finished_info: 'Censo consolidado y cerrado. Resultados históricos y comparativas habilitados.',
    zampa_diana_adult: 'La Diana de Zampa',
    zampa_proximitat_jurat: 'Proximidad a la decisión del jurado',
    zampa_soci_rank_for_winner: 'Posición otorgada al proyecto campeón',
    zampa_afinitat_popular: 'Afinidad Popular (Desviación Manhattan)',
    zampa_afinitat_info: 'Los socios se clasifican según la menor desviación global con el voto popular de la sala.',
    zampa_soci_distance: 'Disenso Global (Desviación)',
  }
};
